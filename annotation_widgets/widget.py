...
def complete_annotation(annotation_logic: AbstractImageAnnotationLogic, root: tk.Tk):
...
def get_widget(project_data: ProjectData, root: tk.Tk) -> AbstractImageAnnotationLogic:
    # TODO: Make it return a Widget and Use AbstractAnnotationWidget.get_widget()
